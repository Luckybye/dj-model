...
var constantSetting = {
  ...
  containersType: function containersType() {
    return [{ en: '40HC', v: 0 }, { en: '40GP', v: 1 }, { en: '20GP', v: 2 }, { en: 'LCL', v: 3 }, { en: 'N/A', v: 10 }, {en: '45HC', v: 12}];
  },
  ...
  currencyType: function currencyType() {
    return [
      { tag: 'Renminbi Yuan', cn: '人民币', en: 'CNY', abbr: '￥' },
      { tag: 'Euro', cn: '欧元', en: 'EUR', abbr: '€' },
      { tag: 'Pound, Sterling', cn: '英镑', en: 'GBP', abbr: '￡' },
      { tag: 'U.S.Dollar', cn: '美元', en: 'USD', abbr: '$' },
      { tag: 'Canadian Dollar', cn: '加拿大元', en: 'CAD', abbr: 'C$' },
      { tag: 'Japanese Yen', cn: '日元', en: 'JPY', abbr: 'J￥' }
    ];
  },
  ...
  prodType: function prodType () {
    return [
      {en: 'product', cn: '产品/整机'},
      {en: 'sparepart', cn: '配件'},
      {en: 'accessories', cn: '附件'},
      {en: 'handtool', cn: '手工具'},
      {en: 'materiel', cn: '物料'},
      {en: 'promotional', cn: '促销品'}
    ]
  },
  prodLevel: function prodLevel () {
    return [
      {en: 'Civil', cn: '民用级'},
      {en: 'Industrial', cn: '工业级'},
      {en: 'Professional', cn: '专业级'},
      {en: 'Semi-professional', cn: '半专业级'},
      {en: 'Disabled', cn: '淘汰产品'},
      {en: 'Other', cn: '其他'}
    ]
  }
